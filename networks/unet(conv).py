...
class unet_conv(nn.Module):
    def __init__(self, sizeP=5, in_channels=3, classes=2):
        ...
        self.inc = Inconv(7, in_channels, 32)
        self.down1 = Down(sizeP, 32, 64, 2, 2)
        self.down2 = Down(sizeP, 64, 128, 2, 2)
        self.down3 = Down(sizeP, 128, 256, 2, 2)
        self.down4 = Down(sizeP, 256, 256, 2, 2)
        self.up1 = Up(sizeP, 512, 128, None, 2)
        self.up2 = Up(sizeP, 256, 64, None, 2)
        self.up3 = Up(sizeP, 128, 32, None, 2)
        self.up4 = Up(sizeP, 64, 32, None, 2)
